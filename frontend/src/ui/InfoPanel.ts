...
import { GcodeMetadata, computeSpeedStats, computeLayerTimes, formatTime } from '../core/GcodeMetadata';
import { MiniplotData } from '../renderers/MiniplotRenderer';
import {
  detectStringingRisk,
